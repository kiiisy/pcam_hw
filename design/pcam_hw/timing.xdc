...
create_clock -period 1.667 -name video_dynclk [get_pins -regexp .*clk_wiz_1/.*/mmcm_adv_inst/CLKOUT0 -hierarchical]
...
set_false_path -from [get_port {dphy_data_hs_n[0]}] -to [get_pins {design_1_i/MIPI_D_PHY_RX_0/U0/DataLaneGen[0].DPHY_LaneSFEN_X/HSDeserializerX/Deserializer/DDLY}]
set_false_path -from [get_port {dphy_data_hs_n[1]}] -to [get_pins {design_1_i/MIPI_D_PHY_RX_0/U0/DataLaneGen[1].DPHY_LaneSFEN_X/HSDeserializerX/Deserializer/DDLY}]
set_false_path -from [get_port {dphy_data_hs_p[0]}] -to [get_pins {design_1_i/MIPI_D_PHY_RX_0/U0/DataLaneGen[0].DPHY_LaneSFEN_X/HSDeserializerX/Deserializer/DDLY}]
set_false_path -from [get_port {dphy_data_hs_p[1]}] -to [get_pins {design_1_i/MIPI_D_PHY_RX_0/U0/DataLaneGen[1].DPHY_LaneSFEN_X/HSDeserializerX/Deserializer/DDLY}]